...
def writeTextFile(svgfile, name = "/Users/andrew/PycharmProjects/Experiments/psudocode/pythonfixed.py"):
    ...
    """
    name = 'F:/SDD/PMDlikeGAME/GameVer1.7.1/PseudoCode/' + name[0:len(name)-3] + "-Psudocode" + ".txt"
    file = open(name, 'w')
    mainstr = ""
...
onlyfiles = [f for f in listdir(path.dirname(__file__))]

for i in onlyfiles:
    if i[-3:] == ".py" and i != "psuedo.py":
        main(i)
